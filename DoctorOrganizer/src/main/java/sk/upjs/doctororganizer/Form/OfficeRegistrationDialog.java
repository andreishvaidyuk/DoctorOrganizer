...
public class OfficeRegistrationDialog extends javax.swing.JDialog {
    ...
    public OfficeRegistrationDialog(java.awt.Frame parent, boolean modal) {
        ...
        textFieldList.add(placeTextField);
        textFieldList.add(descriptionNumberTextField);
        textFieldList.add(hospotialTextField);
    ...
    private void registerButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerButtonActionPerformed
        ...
        try {
            ...
            String time = fromComboBox.getSelectedItem().toString() + "-" + toComboBox.getSelectedItem().toString();
            ...
            infoLabel.setText("Pridanie ordinácie bolo úspešné, stlačte zavrieť");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OfficeRegistrationDialog.class
